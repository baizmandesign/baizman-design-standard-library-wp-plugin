...
function bzmndsgn_advanced_settings () {
	...
	<form method="post" action="<?php echo admin_url('admin-post.php') ; ?>">
		...
		<input type="hidden" name="action" value="cas_reserialize_data">
		<?php wp_nonce_field ( 'cas_reserialize_data' ); ?>
	...
	<form method="post" action="<?php echo admin_url('admin-post.php') ; ?>">
		...
		<input type="hidden" name="action" value="cas_reinitialize_default_data">
		<?php wp_nonce_field ( 'cas_reinitialize_default_data' ); ?>
