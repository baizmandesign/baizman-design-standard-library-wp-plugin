...
function bzmndsgn_content_sanitizers () {
	...
	$strip_content_blank_lines_on_save = new checkbox( 'Strip blank lines from the body of posts when <u>saving</u> them?','checkbox-strip_content_blank_lines_on_save',$bzmndsgn_config_options_database['checkbox-strip_content_blank_lines_on_save']) ;
	$content_sanitizers_settings_form->add_form_field ($strip_content_blank_lines_on_save) ;

	$strip_content_blank_lines_on_display = new checkbox( 'Strip blank lines from the body of posts when <u>displaying</u> them?','checkbox-strip_content_blank_lines_on_display',$bzmndsgn_config_options_database['checkbox-strip_content_blank_lines_on_display']) ;
